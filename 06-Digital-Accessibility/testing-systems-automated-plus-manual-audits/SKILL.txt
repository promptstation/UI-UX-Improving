---
name: testing-systems-automated-plus-manual-audits
description: Combine automated and manual testing. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 7: Testing Systems — Automated plus Manual Audits (Digital Accessibility (a11y)).
...
# Testing Systems — Automated plus Manual Audits

## Mission

Deliver the Section 7 capability of Digital Accessibility (a11y): combine automated and manual testing. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Combine automated and manual testing.
- Run screen-reader passes.
- Lock gains with regression tests.

Context of this section: Layering axe-style automation with screen-reader passes and disabled-user testing, plus regression suites preventing reintroduction.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 7: Testing Systems — Automated plus Manual Audits via Evidence-led audit." Do not blend approaches accidentally.
