---
name: capstone-certified-accessible-experience
description: Deliver AA-conformant experiences with evidence. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 8: Capstone — Certified Accessible Experience (Digital Accessibility (a11y)).
...
# Capstone — Certified Accessible Experience

## Mission

Deliver the Section 8 capability of Digital Accessibility (a11y): deliver AA-conformant experiences with evidence. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Deliver AA-conformant experiences with evidence.
- Publish conformance statements.
- Prevent regression.

Context of this section: Full capstone: audited product remediated to AA with evidence, test reports, conformance statement, and regression protection.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Certified Accessible Experience via Evidence-led audit." Do not blend approaches accidentally.
