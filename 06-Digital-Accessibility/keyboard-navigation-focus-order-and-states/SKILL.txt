---
name: keyboard-navigation-focus-order-and-states
description: Build fully keyboard-operable flows. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 3: Keyboard Navigation — Focus Order and States (Digital Accessibility (a11y)).
...
# Keyboard Navigation — Focus Order and States

## Mission

Deliver the Section 3 capability of Digital Accessibility (a11y): build fully keyboard-operable flows. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Build fully keyboard-operable flows.
- Show visible focus always.
- Implement correct dialog and widget patterns.

Context of this section: Logical tab order, visible focus states, skip links, focus traps for dialogs, and roving-tabindex widget patterns.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 3: Keyboard Navigation — Focus Order and States via Evidence-led audit." Do not blend approaches accidentally.
