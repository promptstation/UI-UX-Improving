---
name: wcag-foundations-principles-and-conformance
description: Scope audits by template. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 1: WCAG Foundations — Principles and Conformance (Digital Accessibility (a11y)).
...
# WCAG Foundations — Principles and Conformance

## Mission

Deliver the Section 1 capability of Digital Accessibility (a11y): scope audits by template. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Scope audits by template.
- Target correct conformance levels.
- Write defensible conformance claims.

Context of this section: POUR principles, A versus AA versus AAA targets, scoping audits by template, and writing conformance claims that survive scrutiny.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 1: WCAG Foundations — Principles and Conformance via Evidence-led audit." Do not blend approaches accidentally.
