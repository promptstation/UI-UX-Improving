---
name: contrast-and-color-4-5-1-discipline
description: Verify 4.5:1 and 3:1 ratios everywhere. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 2: Contrast and Color — 4.5:1 Discipline (Digital Accessibility (a11y)).
...
# Contrast and Color — 4.5:1 Discipline

## Mission

Deliver the Section 2 capability of Digital Accessibility (a11y): verify 4.5:1 and 3:1 ratios everywhere. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Verify 4.5:1 and 3:1 ratios everywhere.
- Remove color-only meaning.
- Prove dark-mode compliance.

Context of this section: Text and non-text contrast ratios, focus-indicator contrast, color-independence of meaning, and dark-mode contrast verification.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: Contrast and Color — 4.5:1 Discipline via Evidence-led audit." Do not blend approaches accidentally.
