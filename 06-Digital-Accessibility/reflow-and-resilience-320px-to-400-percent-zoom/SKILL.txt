---
name: reflow-and-resilience-320px-to-400-percent-zoom
description: Build reflow-proof layouts. Use when the user asks to audit against WCAG, fix contrast, repair keyboard flows, correct semantics, or certify AA. Covers Section 5: Reflow and Resilience — 320px to 400 Percent Zoom (Digital Accessibility (a11y)).
...
# Reflow and Resilience — 320px to 400 Percent Zoom

## Mission

Deliver the Section 5 capability of Digital Accessibility (a11y): build reflow-proof layouts. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Build reflow-proof layouts.
- Pass spacing-override tests.
- Keep content reachable at extreme zoom.

Context of this section: Reflow containers surviving 320px widths and 400 percent zoom: no two-dimensional scrolling, spacing overrides, and truncation discipline.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 5: Reflow and Resilience — 320px to 400 Percent Zoom via Evidence-led audit." Do not blend approaches accidentally.
