---
name: capstone-fully-automated-release-pipeline
description: Deliver zero-touch release automation. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 8: Capstone — Fully Automated Release Pipeline (CI/CD & Release Automation).
...
# Capstone — Fully Automated Release Pipeline

## Mission

Deliver the Section 8 capability of CI/CD & Release Automation: deliver zero-touch release automation. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Deliver zero-touch release automation.
- Evidence gates and sync.
- Hand over operable pipelines.

Context of this section: Full capstone: repository where merged conventional commits auto-version, sync files, pass gates, and publish with zero manual steps.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Fully Automated Release Pipeline via Zero-touch release." Do not blend approaches accidentally.
