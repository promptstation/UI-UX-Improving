---
name: release-channels-beta-rc-and-stable-flows
description: Run beta and RC channels. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 6: Release Channels — Beta, RC and Stable Flows (CI/CD & Release Automation).
...
# Release Channels — Beta, RC and Stable Flows

## Mission

Deliver the Section 6 capability of CI/CD & Release Automation: run beta and RC channels. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Run beta and RC channels.
- Promote safely to stable.
- Communicate breaking changes clearly.

Context of this section: Prerelease channels, promotion mechanics, dist-tag management, and communicating breaking changes across channels.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 6: Release Channels — Beta, RC and Stable Flows via Zero-touch release." Do not blend approaches accidentally.
