---
name: conventional-commits-machine-readable-history
description: Write spec-compliant commits. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 2: Conventional Commits — Machine-Readable History (CI/CD & Release Automation).
...
# Conventional Commits — Machine-Readable History

## Mission

Deliver the Section 2 capability of CI/CD & Release Automation: write spec-compliant commits. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Write spec-compliant commits.
- Enforce linting.
- Turn history into accurate changelogs.

Context of this section: The Conventional Commits specification, commit linting in hooks and CI, scope discipline, and how clean history powers automated changelogs.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: Conventional Commits — Machine-Readable History via Zero-touch release." Do not blend approaches accidentally.
