---
name: multi-file-version-sync-one-version-across-architectures
description: Sync versions across heterogeneous files. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 4: Multi-File Version Sync — One Version Across Architectures (CI/CD & Release Automation).
...
# Multi-File Version Sync — One Version Across Architectures

## Mission

Deliver the Section 4 capability of CI/CD & Release Automation: sync versions across heterogeneous files. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Sync versions across heterogeneous files.
- Verify consistency in CI.
- Prevent drift permanently.

Context of this section: Propagating a single version into manifests, lockfiles, generated clients, and docs, with verification steps proving every file agrees.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 4: Multi-File Version Sync — One Version Across Architectures via Zero-touch release." Do not blend approaches accidentally.
