---
name: ci-foundations-github-actions-workflows
description: Author matrixed workflows with caching. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 1: CI Foundations — GitHub Actions Workflows (CI/CD & Release Automation).
...
# CI Foundations — GitHub Actions Workflows

## Mission

Deliver the Section 1 capability of CI/CD & Release Automation: author matrixed workflows with caching. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Author matrixed workflows with caching.
- Manage secrets safely.
- Keep CI fast and deterministic.

Context of this section: Workflow anatomy: events, jobs, matrices, caching, artifacts, and secrets hygiene, establishing reliable continuous integration for multi-file architectures.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 1: CI Foundations — GitHub Actions Workflows via Zero-touch release." Do not blend approaches accidentally.
