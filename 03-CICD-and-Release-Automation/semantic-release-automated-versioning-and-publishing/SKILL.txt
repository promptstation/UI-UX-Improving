---
name: semantic-release-automated-versioning-and-publishing
description: Configure semantic-release end to end. Use when the user asks to author workflows, enforce conventional commits, automate versioning, sync multi-file versions, or gate releases. Covers Section 3: semantic-release — Automated Versioning and Publishing (CI/CD & Release Automation).
...
Deliver the Section 3 capability of CI/CD & Release Automation: configure semantic-release end to end. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Configure semantic-release end to end.
- Control publishing per branch.
- Eliminate manual versioning.

Context of this section: semantic-release pipeline: commit analysis, version calculation, GitHub and npm publishing, and branch strategies for controlled automation.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 3: semantic-release — Automated Versioning and Publishing via Zero-touch release." Do not blend approaches accidentally.
