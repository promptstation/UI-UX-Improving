---
name: versioned-knowledge-evolving-layouts-safely
description: Version schemas safely. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 6: Versioned Knowledge — Evolving Layouts Safely (Reasoning Engine Layouts).
...
# Versioned Knowledge — Evolving Layouts Safely

## Mission

Deliver the Section 6 capability of Reasoning Engine Layouts: version schemas safely. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Versioning layout schemas, migrating datasets without breaking sessions, and compatibility windows for consuming agents.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 6: Versioned Knowledge — Evolving Layouts Safely via Hierarchical consumption." Do not blend approaches accidentally.
