---
name: validation-layers-catching-model-drift
description: Validate outputs against schemas. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 5: Validation Layers — Catching Model Drift (Reasoning Engine Layouts).
...
# Validation Layers — Catching Model Drift

## Mission

Deliver the Section 5 capability of Reasoning Engine Layouts: validate outputs against schemas. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Validate outputs against schemas.
- Snapshot-test generations.
- Build retry loops.

Context of this section: Schema validation of model outputs, snapshot tests for generated code, and reject-and-retry loops keeping sessions on rails.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 5: Validation Layers — Catching Model Drift via Hierarchical consumption." Do not blend approaches accidentally.
