---
name: constraint-formatting-rules-machines-can-follow
description: Express constraints models obey. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 3: Constraint Formatting — Rules Machines Can Follow (Reasoning Engine Layouts).
...
# Constraint Formatting — Rules Machines Can Follow

## Mission

Deliver the Section 3 capability of Reasoning Engine Layouts: express constraints models obey. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Express constraints models obey.
- Prefer enums over prose.
- Verify compliance rates.

Context of this section: Allow and deny lists, enums, required fields, and pattern constraints expressed so models comply reliably under session pressure.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 3: Constraint Formatting — Rules Machines Can Follow via Hierarchical consumption." Do not blend approaches accidentally.
