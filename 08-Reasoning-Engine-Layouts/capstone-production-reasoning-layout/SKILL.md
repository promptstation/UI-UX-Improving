---
name: capstone-production-reasoning-layout
description: Ship production reasoning layouts. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 8: Capstone — Production Reasoning Layout (Reasoning Engine Layouts).
...
# Capstone — Production Reasoning Layout

## Mission

Deliver the Section 8 capability of Reasoning Engine Layouts: ship production reasoning layouts. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Ship production reasoning layouts.
- Prove reliability with evals.
- Operate versioned knowledge.

Context of this section: Full capstone: versioned master-plus-overrides dataset powering real coding sessions, with validation, budgets, and evals proving reliability.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Production Reasoning Layout via Hierarchical consumption." Do not blend approaches accidentally.
