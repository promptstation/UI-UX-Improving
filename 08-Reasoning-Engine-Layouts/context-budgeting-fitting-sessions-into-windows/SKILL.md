---
name: context-budgeting-fitting-sessions-into-windows
description: Budget layouts to context windows. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 4: Context Budgeting — Fitting Sessions into Windows (Reasoning Engine Layouts).
...
# Context Budgeting — Fitting Sessions into Windows

## Mission

Deliver the Section 4 capability of Reasoning Engine Layouts: budget layouts to context windows. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Budget layouts to context windows.
- Disclose progressively.
- Measure cost per layout.

Context of this section: Prioritizing records by relevance, progressive disclosure via references, summarization layers, and measuring token cost per layout.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 4: Context Budgeting — Fitting Sessions into Windows via Hierarchical consumption." Do not blend approaches accidentally.
