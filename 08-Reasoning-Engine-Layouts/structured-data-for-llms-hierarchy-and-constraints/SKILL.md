---
name: structured-data-for-llms-hierarchy-and-constraints
description: Design model-legible hierarchies. Use when the user asks to design model-legible hierarchies, implement master-plus-overrides, budget context, or debug layout faults. Covers Section 1: Structured Data for LLMs — Hierarchy and Constraints (Reasoning Engine Layouts).
...
# Structured Data for LLMs — Hierarchy and Constraints

## Mission

Deliver the Section 1 capability of Reasoning Engine Layouts: design model-legible hierarchies. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Design model-legible hierarchies.
- Write constraining schemas.
- Format data for session consumption.

Context of this section: Designing schemas, frontmatter, and nested records so models consume data hierarchically instead of as flat text during coding sessions.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 1: Structured Data for LLMs — Hierarchy and Constraints via Hierarchical consumption." Do not blend approaches accidentally.
