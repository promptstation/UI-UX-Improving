---
name: capstone-production-local-search-engine
description: Deliver a benchmarked local search engine. Use when the user asks to build tokenizers and indexes, implement BM25, tune relevance, or ship zero-dependency search. Covers Section 8: Capstone — Production Local Search Engine (Local Search Engines).
...
# Capstone — Production Local Search Engine

## Mission

Deliver the Section 8 capability of Local Search Engines: deliver a benchmarked local search engine. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Full capstone: BM25 search engine over a real multi-thousand-row dataset, benchmarked for latency and relevance, packaged with tests and docs.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Production Local Search Engine via Stdlib purity." Do not blend approaches accidentally.
