---
name: packaging-local-search-embeddable-zero-dependency-modules
description: Ship zero-dependency search modules. Use when the user asks to build tokenizers and indexes, implement BM25, tune relevance, or ship zero-dependency search. Covers Section 7: Packaging Local Search — Embeddable Zero-Dependency Modules (Local Search Engines).
...
# Packaging Local Search — Embeddable Zero-Dependency Modules

## Mission

Deliver the Section 7 capability of Local Search Engines: ship zero-dependency search modules. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Clean embeddable API design, index serialization formats, versioning indexes across releases, and documentation for integrators.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 7: Packaging Local Search — Embeddable Zero-Dependency Modules via Stdlib purity." Do not blend approaches accidentally.
