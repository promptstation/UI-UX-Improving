---
name: ranking-science-tf-idf-to-bm25
description: Implement BM25 from scratch. Use when the user asks to build tokenizers and indexes, implement BM25, tune relevance, or ship zero-dependency search. Covers Section 2: Ranking Science — TF-IDF to BM25 (Local Search Engines).
...
# Ranking Science — TF-IDF to BM25

## Mission

Deliver the Section 2 capability of Local Search Engines: implement BM25 from scratch. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Term-frequency statistics through BM25: saturation, length normalization, tuning k1 and b, and why BM25 remains the default for keyword relevance.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: Ranking Science — TF-IDF to BM25 via Stdlib purity." Do not blend approaches accidentally.
