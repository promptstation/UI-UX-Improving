---
name: bun-powered-tooling-fast-cross-platform-scripts
description: Write Bun-native scripts and CLIs. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 3: Bun-Powered Tooling — Fast Cross-Platform Scripts (CLI Development & Automation).
...
# Bun-Powered Tooling — Fast Cross-Platform Scripts

## Mission

Deliver the Section 3 capability of CLI Development & Automation: write Bun-native scripts and CLIs. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Bun runtime for instant-start scripting: file and shell APIs, bundling single-file binaries, package management speed, and when Bun beats Node for CLI distribution.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 3: Bun-Powered Tooling — Fast Cross-Platform Scripts via Interactive scaffolding." Do not blend approaches accidentally.
