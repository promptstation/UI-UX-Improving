---
name: typescript-for-clis-typed-commands-and-config
description: Define typed commands and options. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 2: TypeScript for CLIs — Typed Commands and Config (CLI Development & Automation).
...
# TypeScript for CLIs — Typed Commands and Config

## Mission

Deliver the Section 2 capability of CLI Development & Automation: define typed commands and options. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Type-safe command definitions, option schemas, config-file layering with validation, and strict typing of filesystem operations so CLI behavior is predictable and refactor-safe.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: TypeScript for CLIs — Typed Commands and Config via Interactive scaffolding." Do not blend approaches accidentally.
