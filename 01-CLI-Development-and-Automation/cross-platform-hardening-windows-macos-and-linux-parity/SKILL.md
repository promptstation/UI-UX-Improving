---
name: cross-platform-hardening-windows-macos-and-linux-parity
description: Ship identical CLI behavior on three platforms. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 6: Cross-Platform Hardening — Windows, macOS and Linux Parity (CLI Development & Automation).
...
# Cross-Platform Hardening — Windows, macOS and Linux Parity

## Mission

Deliver the Section 6 capability of CLI Development & Automation: ship identical CLI behavior on three platforms. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Path, shell, permission, and line-ending differences across platforms, CI matrices covering all three OS families, and graceful degradation where parity is impossible.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 6: Cross-Platform Hardening — Windows, macOS and Linux Parity via Interactive scaffolding." Do not blend approaches accidentally.
