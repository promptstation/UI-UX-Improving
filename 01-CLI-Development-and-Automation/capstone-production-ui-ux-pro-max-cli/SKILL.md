---
name: capstone-production-ui-ux-pro-max-cli
description: Deliver a production global CLI end to end. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 8: Capstone — Production ui-ux-pro-max-cli (CLI Development & Automation).
...
# Capstone — Production ui-ux-pro-max-cli

## Mission

Deliver the Section 8 capability of CLI Development & Automation: deliver a production global CLI end to end. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Full capstone delivering the global `ui-ux-pro-max-cli`: init scaffolding, config editing, cross-platform CI, tests, documentation, and versioned release ready for real users.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Production ui-ux-pro-max-cli via Interactive scaffolding." Do not blend approaches accidentally.
