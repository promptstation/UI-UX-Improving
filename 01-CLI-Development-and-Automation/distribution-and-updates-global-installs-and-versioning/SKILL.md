---
name: distribution-and-updates-global-installs-and-versioning
description: Publish global CLIs through multiple channels. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 7: Distribution and Updates — Global Installs and Versioning (CLI Development & Automation).
...
# Distribution and Updates — Global Installs and Versioning

## Mission

Deliver the Section 7 capability of CLI Development & Automation: publish global CLIs through multiple channels. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Global installation via npm, bunx, and standalone binaries, version channels, update notifications, and checksum-verified downloads for trustworthy distribution.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 7: Distribution and Updates — Global Installs and Versioning via Interactive scaffolding." Do not blend approaches accidentally.
