---
name: system-configuration-editing-safe-programmatic-modification
description: Modify system configs programmatically. Use when the user asks to build parsers and subcommands, scaffold with init commands, edit system configs safely, or ship cross-platform CLIs. Covers Section 5: System Configuration Editing — Safe Programmatic Modification (CLI Development & Automation).
...
# System Configuration Editing — Safe Programmatic Modification

## Mission

Deliver the Section 5 capability of CLI Development & Automation: modify system configs programmatically. Work from evidence, protect what matters, and prove the result at full size before delivery.
...
Context of this section: Programmatic modification of system and project configs: dotfiles, registries, and rc files, with backup, diff preview, validation, and rollback on every write.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 5: System Configuration Editing — Safe Programmatic Modification via Interactive scaffolding." Do not blend approaches accidentally.
