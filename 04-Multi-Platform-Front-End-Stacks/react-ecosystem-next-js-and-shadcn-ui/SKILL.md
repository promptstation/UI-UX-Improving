---
name: react-ecosystem-next-js-and-shadcn-ui
description: Ship Next.js apps with correct rendering choices. Use when the user asks to map stack architectures, build per-stack features, enforce cross-stack parity, or share logic natively. Covers Section 2: React Ecosystem — Next.js and shadcn/ui (Multi-Platform Front-End Stacks).
...
# React Ecosystem — Next.js and shadcn/ui

## Mission

Deliver the Section 2 capability of Multi-Platform Front-End Stacks: ship Next.js apps with correct rendering choices. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Ship Next.js apps with correct rendering choices.
- Theme and compose shadcn/ui.
- Harden for production.

Context of this section: Next.js routing and rendering modes, server components discipline, shadcn/ui theming and composition, and production hardening for React delivery.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: React Ecosystem — Next.js and shadcn/ui via Spec-driven builds." Do not blend approaches accidentally.
