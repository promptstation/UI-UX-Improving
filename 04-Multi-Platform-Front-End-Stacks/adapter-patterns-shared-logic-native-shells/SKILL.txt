---
name: adapter-patterns-shared-logic-native-shells
description: Share logic via generated clients and packages. Use when the user asks to map stack architectures, build per-stack features, enforce cross-stack parity, or share logic natively. Covers Section 7: Adapter Patterns — Shared Logic, Native Shells (Multi-Platform Front-End Stacks).
...
# Adapter Patterns — Shared Logic, Native Shells

## Mission

Deliver the Section 7 capability of Multi-Platform Front-End Stacks: share logic via generated clients and packages. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Share logic via generated clients and packages.
- Keep each shell idiomatic.
- Version shared contracts.

Context of this section: Sharing API clients, validation, and business rules across stacks via codegen and packages while keeping shells idiomatically native.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 7: Adapter Patterns — Shared Logic, Native Shells via Spec-driven builds." Do not blend approaches accidentally.
