---
name: stack-cartography-mapping-22-ecosystems
description: Map stacks by architecture and fit. Use when the user asks to map stack architectures, build per-stack features, enforce cross-stack parity, or share logic natively. Covers Section 1: Stack Cartography — Mapping 22 Ecosystems (Multi-Platform Front-End Stacks).
...
# Stack Cartography — Mapping 22 Ecosystems

## Mission

Deliver the Section 1 capability of Multi-Platform Front-End Stacks: map stacks by architecture and fit. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Map stacks by architecture and fit.
- Build selection matrices.
- Justify stack choices with evidence.

Context of this section: Surveying web, desktop, and mobile stacks by language, runtime, rendering model, and distribution, building a decision matrix for choosing stacks per product need.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 1: Stack Cartography — Mapping 22 Ecosystems via Spec-driven builds." Do not blend approaches accidentally.
