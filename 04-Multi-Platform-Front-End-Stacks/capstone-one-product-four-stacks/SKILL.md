---
name: capstone-one-product-four-stacks
description: Deliver one product across four stacks. Use when the user asks to map stack architectures, build per-stack features, enforce cross-stack parity, or share logic natively. Covers Section 8: Capstone — One Product, Four Stacks (Multi-Platform Front-End Stacks).
...
# Capstone — One Product, Four Stacks

## Mission

Deliver the Section 8 capability of Multi-Platform Front-End Stacks: deliver one product across four stacks. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Deliver one product across four stacks.
- Evidence parity with tests.
- Document stack-specific decisions.

Context of this section: Full capstone: one product brief shipped on web, desktop, and both mobile platforms with proven visual and behavioral parity.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — One Product, Four Stacks via Spec-driven builds." Do not blend approaches accidentally.
