---
name: category-palettes-product-driven-color-logic
description: Build category-bound palettes. Use when the user asks to architect tokens, bind palettes to categories, pair typefaces, specify components, or govern systems. Covers Section 2: Category Palettes — Product-Driven Color Logic (Design Systems & Tokenization).
...
# Category Palettes — Product-Driven Color Logic

## Mission

Deliver the Section 2 capability of Design Systems & Tokenization: build category-bound palettes. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Build category-bound palettes.
- Guarantee contrast pairs.
- Derive dark modes systematically.

Context of this section: Palettes bound to product categories: semantic roles, contrast-paired ramps, dark-mode derivation, and rules preventing off-palette drift.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: Category Palettes — Product-Driven Color Logic via Tiered tokens." Do not blend approaches accidentally.
