---
name: component-logic-variants-states-and-slots
description: Specify variant and state logic. Use when the user asks to architect tokens, bind palettes to categories, pair typefaces, specify components, or govern systems. Covers Section 4: Component Logic — Variants, States and Slots (Design Systems & Tokenization).
...
# Component Logic — Variants, States and Slots

## Mission

Deliver the Section 4 capability of Design Systems & Tokenization: specify variant and state logic. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Specify variant and state logic.
- Design composable slot APIs.
- Keep contracts consistent.

Context of this section: Component APIs as logic: variant matrices, state machines for interactive states, slot composition, and prop contracts across frameworks.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 4: Component Logic — Variants, States and Slots via Tiered tokens." Do not blend approaches accidentally.
