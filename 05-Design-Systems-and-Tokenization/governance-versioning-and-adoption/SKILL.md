---
name: governance-versioning-and-adoption
description: Version and deprecate safely. Use when the user asks to architect tokens, bind palettes to categories, pair typefaces, specify components, or govern systems. Covers Section 7: Governance — Versioning and Adoption (Design Systems & Tokenization).
...
Deliver the Section 7 capability of Design Systems & Tokenization: version and deprecate safely. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Version and deprecate safely.
- Document as contract.
- Enforce adoption with linting.

Context of this section: Changesets for design tokens, deprecation policy, documentation as contract, and lint rules enforcing system usage.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 7: Governance — Versioning and Adoption via Tiered tokens." Do not blend approaches accidentally.
