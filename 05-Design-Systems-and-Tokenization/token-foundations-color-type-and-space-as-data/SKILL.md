---
name: token-foundations-color-type-and-space-as-data
description: Architect tiered token systems. Use when the user asks to architect tokens, bind palettes to categories, pair typefaces, specify components, or govern systems. Covers Section 1: Token Foundations — Color, Type and Space as Data (Design Systems & Tokenization).
...
# Token Foundations — Color, Type and Space as Data

## Mission

Deliver the Section 1 capability of Design Systems & Tokenization: architect tiered token systems. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Architect tiered token systems.
- Name tokens for scale.
- Export to every target format.

Context of this section: Token tiers from primitive to semantic to component, naming conventions, multi-format export, and single-source-of-truth governance.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 1: Token Foundations — Color, Type and Space as Data via Tiered tokens." Do not blend approaches accidentally.
