---
name: capstone-shipped-tokenized-design-system
description: Ship complete tokenized systems. Use when the user asks to architect tokens, bind palettes to categories, pair typefaces, specify components, or govern systems. Covers Section 8: Capstone — Shipped Tokenized Design System (Design Systems & Tokenization).
...
# Capstone — Shipped Tokenized Design System

## Mission

Deliver the Section 8 capability of Design Systems & Tokenization: ship complete tokenized systems. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Ship complete tokenized systems.
- Prove adoption.
- Govern evolution professionally.

Context of this section: Full capstone: tokens to components to landing pages, versioned, documented, and adopted by a real consuming project.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Shipped Tokenized Design System via Tiered tokens." Do not blend approaches accidentally.
