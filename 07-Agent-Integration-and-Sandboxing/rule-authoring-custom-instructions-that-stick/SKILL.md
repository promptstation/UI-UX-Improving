---
name: rule-authoring-custom-instructions-that-stick
description: Author scoped rules agents follow. Use when the user asks to map agent context, author rules, package plugins, sandbox execution, or evaluate compliance. Covers Section 2: Rule Authoring — Custom Instructions That Stick (Agent Integration & Sandboxing).
...
# Rule Authoring — Custom Instructions That Stick

## Mission

Deliver the Section 2 capability of Agent Integration & Sandboxing: author scoped rules agents follow. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Author scoped rules agents follow.
- Prioritize without contradiction.
- Encode failure prevention.

Context of this section: Writing scoped, prioritized rules: project versus global scope, positive directives over prohibitions, and negative examples that prevent known failures.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 2: Rule Authoring — Custom Instructions That Stick via Standardized rules." Do not blend approaches accidentally.
