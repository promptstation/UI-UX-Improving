---
name: plugin-and-skill-packaging-distributable-agent-extensions
description: Package distributable agent extensions. Use when the user asks to map agent context, author rules, package plugins, sandbox execution, or evaluate compliance. Covers Section 3: Plugin and Skill Packaging — Distributable Agent Extensions (Agent Integration & Sandboxing).
...
# Plugin and Skill Packaging — Distributable Agent Extensions

## Mission

Deliver the Section 3 capability of Agent Integration & Sandboxing: package distributable agent extensions. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Package distributable agent extensions.
- Version and document them.
- Verify installation paths.

Context of this section: Packaging commands, references, and scripts as installable plugins or skills with manifests, versioning, and documentation.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 3: Plugin and Skill Packaging — Distributable Agent Extensions via Standardized rules." Do not blend approaches accidentally.
