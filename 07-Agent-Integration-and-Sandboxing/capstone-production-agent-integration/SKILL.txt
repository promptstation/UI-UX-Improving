---
name: capstone-production-agent-integration
description: Ship production agent integrations. Use when the user asks to map agent context, author rules, package plugins, sandbox execution, or evaluate compliance. Covers Section 8: Capstone — Production Agent Integration (Agent Integration & Sandboxing).
...
# Capstone — Production Agent Integration

## Mission

Deliver the Section 8 capability of Agent Integration & Sandboxing: ship production agent integrations. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Ship production agent integrations.
- Evidence parity and evals.
- Sign off security posture.

Context of this section: Full capstone: rules plus plugin plus sandbox plus evals shipped for a real repo, with parity across agents and security signoff.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 8: Capstone — Production Agent Integration via Standardized rules." Do not blend approaches accidentally.
