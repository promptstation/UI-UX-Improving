---
name: multi-agent-parity-four-tools-one-standard
description: Port one standard across four agents. Use when the user asks to map agent context, author rules, package plugins, sandbox execution, or evaluate compliance. Covers Section 5: Multi-Agent Parity — Four Tools, One Standard (Agent Integration & Sandboxing).
...
# Multi-Agent Parity — Four Tools, One Standard

## Mission

Deliver the Section 5 capability of Agent Integration & Sandboxing: port one standard across four agents. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Port one standard across four agents.
- Prove parity with tests.
- Document per-tool gaps.

Context of this section: Mapping one rule standard onto Claude Code, Cursor, Windsurf, and Copilot configs, with parity tests proving equivalent behavior.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 5: Multi-Agent Parity — Four Tools, One Standard via Standardized rules." Do not blend approaches accidentally.
