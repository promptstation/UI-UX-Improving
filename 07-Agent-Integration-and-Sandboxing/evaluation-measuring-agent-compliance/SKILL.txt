---
name: evaluation-measuring-agent-compliance
description: Build compliance task suites. Use when the user asks to map agent context, author rules, package plugins, sandbox execution, or evaluate compliance. Covers Section 6: Evaluation — Measuring Agent Compliance (Agent Integration & Sandboxing).
...
# Evaluation — Measuring Agent Compliance

## Mission

Deliver the Section 6 capability of Agent Integration & Sandboxing: build compliance task suites. Work from evidence, protect what matters, and prove the result at full size before delivery.

Capability targets for this skill:

- Build compliance task suites.
- Score outputs with rubrics.
- Catch drift across updates.

Context of this section: Task suites measuring rule compliance, regression prompts catching drift across model updates, and scoring rubrics for agent output.
...
Choose exactly one approach per piece from the list above. Record it in one line with the section number, for example: "Section 6: Evaluation — Measuring Agent Compliance via Standardized rules." Do not blend approaches accidentally.
